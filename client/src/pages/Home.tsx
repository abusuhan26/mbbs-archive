...
export default function Home() {
  ...
  return <div className="app-shell"><Particles />
    ...
    <main id="top"><section className="hero-section"><div className="hero-content"><div className="eyebrow"><span /> The student-built index <span /></div><h1>All your years.<br /><i>One quiet place.</i></h1><p className="hero-copy">A considered home for the books, notes, and links that carry you through five years of medicine.</p><div className="hero-cta"><a className="primary-button" href="#library">Open the archive <ArrowUpRight size={16} /></a><span className="hero-note"></span></div></div><div className="orbit-art" aria-hidden="true"><div className="orbit orbit-one" /><div className="orbit orbit-two" /><div className="orbit-core"><ThreeOrb /><span><br /><small>01</small></span></div><div className="orbit-label label-a">Read. Revise. Repeat.</div><div className="orbit-label label-b">Notes in orbit</div></div><div className="scroll-cue"><span /> Scroll to explore</div></section>
